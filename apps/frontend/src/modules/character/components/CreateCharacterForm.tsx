  ...
  return (
    <YStack gap="$4">
      ...
      <FormField
        ...
        inputProps={{
          placeholder: t("character.createForm.namePlaceholder"),
      ...
      <FormField
        ...
        inputProps={{
          placeholder: t("character.createForm.titlePlaceholder"),
          autoCapitalize: "words",
        }}
      />
            ...
            <XStack flexWrap="wrap" gap="$2">
              {CLASS_OPTIONS.map((option) => (
                <SystemButton
                  ...
                  size="$3"
                  backgroundColor={
                    value === option ? "$soloBlue" : "$soloPanelAlt"
                  }
      ...
      >
        {createCharacter.isPending
          ? t("character.createForm.submitting")
          : t("character.createForm.submit")}
      </SystemButton>
    </YStack>
  );
}
