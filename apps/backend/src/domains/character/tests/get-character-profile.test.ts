...
describe('GetCharacterProfileUseCase', () => {
  ...
  it('returns the character profile with computed power score and rank', async () => {
    repository.seed({
      userId: 'user-1',
      name: 'Sung Jinwoo',
      stats: { strength: 10, intelligence: 10, agility: 10, vitality: 10, perception: 10 },
    })
  ...
  it.each([
    [{ strength: 100, intelligence: 100, agility: 100, vitality: 100, perception: 100 }, 500, 'D'],
    [{ strength: 300, intelligence: 300, agility: 300, vitality: 300, perception: 300 }, 1500, 'C'],
    [{ strength: 700, intelligence: 700, agility: 700, vitality: 700, perception: 700 }, 3500, 'B'],
    [{ strength: 1400, intelligence: 1400, agility: 1400, vitality: 1400, perception: 1400 }, 7000, 'A'],
    [{ strength: 2400, intelligence: 2400, agility: 2400, vitality: 2400, perception: 2400 }, 12000, 'S'],
    [{ strength: 3600, intelligence: 3600, agility: 3600, vitality: 3600, perception: 3600 }, 18000, 'SS'],
    [{ strength: 5200, intelligence: 5200, agility: 5200, vitality: 5200, perception: 5200 }, 26000, 'Monarch'],
